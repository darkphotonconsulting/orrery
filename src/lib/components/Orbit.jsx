...
export function OrbitPath({
  ...
  console.log(userData.planet)
  console.log(`testing ${userData.planet.englishName} semimajorAxis: ${userData.planet.semimajorAxis} semiminorAxis: ${userData.planet.semiminorAxis} eccentricity: ${userData.planet.eccentricity} starEquaRadius: ${userData.star.equaRadius} index: ${index}`)
  console.log(
    'testing', (userData.planet.semiminorAxis + userData.star.equaRadius) * (index + 2)
  )
